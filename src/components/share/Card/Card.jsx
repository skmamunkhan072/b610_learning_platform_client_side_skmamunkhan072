...
const Card = () => {
  return (
    <div>
      <div className="card_wraper my-5 drop-shadow-2xl sm:w-8/12 mx-auto md:w-full">
        <div className="w-full mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
          <div className="course-price-badge">bages</div>
          <div className="card_img_wraper">
            <Link to="#">
              <img
                className="rounded-lg card_img_thamnel"
                src={CardImg}
                alt="product imag"
              />
            </Link>
